				...
				<div class="card" style="border: none">
                    ...
                    @include('admin.category.errors')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="extract" name="extract" type="text" class="form-control @error('extract') is-invalid @enderror">
                            </div>
                        </div>
                       ...
                       <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" name="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror">
                            </div>
                        </div>
